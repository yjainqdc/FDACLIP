...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument('--videos_dir', type=str, default='/sshfs/datasets/YJA_dataset/msvd/MSVD_Videos/MSVD_Videos/', help="Location of videos")
        # parser.add_argument('--videos_dir', type=str,default='/sshfs/datasets/YJA_dataset/MSRVTT/MSRVTT_Videos/MSRVTT_Videos/',help="Location of videos")
        ...
        #parser.add_argument('--exp_name', type=str,default='test', required=True, help="Name of the current experiment")
        parser.add_argument('--exp_name', type=str, default='test',help="Name of the current experiment")
        parser.add_argument('--output_dir', type=str, default='./outputs')
        parser.add_argument('--save_every', type=int, default=1, help="Save model every n epochs")
        parser.add_argument('--log_step', type=int, default=50, help="Print training log every n steps")
        ...
        # model parameters
        parser.add_argument('--arch', type=str, default='alphaclip_video') #clip_transformer
        ...
        parser.add_argument('--clip_lr', type=float, default=1e-7                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                , help='Learning rate used for CLIP params') #1e-6
        parser.add_argument('--noclip_lr', type=float, default=1e-7, help='Learning rate used for new params') #1e-5
        ...
        #parser.add_argument('--is_alphaCLIP', type=str, default='no_yes')
