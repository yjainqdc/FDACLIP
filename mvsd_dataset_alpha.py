...
from video_datasets.video_capture import VideoCapture
from video_datasets.video_capture_with_mask import VideoCapture_diff

class MSVDDataset_diff(Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        imgs, diff_mask, idxs = VideoCapture_diff.load_frames_from_video(video_path,
                                                         self.num_frames,
